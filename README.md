...
Una vez validadas las imágenes Docker y construcciones de React, GitHub Actions realiza los despliegues:
  Backend: Los microservicios son desplegados en un clúster Amazon Elastic Kubernetes Service (EKS). Las configuraciones para cada microservicio se gestionan mediante manifiestos de Kubernetes (k8s/orders-  
  service-deployment.yaml, etc.).
